...
public class HybridOrchestratorAgent implements OrchestratorAgent {
    ...
    private static final Set<String> SHOPPING_KEYWORDS = Set.of(
            "шука", "знайд", "пошук", "є у вас", "хочу купити",
            "додай в кошик", "додати в кошик", "кошик", "ціна", "знижк",
            "сукн", "джинс", "куртк", "светр", "пальт",
            "топ", "штан", "блузк", "сорочк", "худі", "піджак",
            "спідниц", "легінс", "шорт", "плащ", "футболк", "костюм",
            "чорн", "біл", "синь", "синя", "червон", "бежев", "сір",
            "бавовн", "шовк", "вовн", "шкір", "денім",
            "zara", "mango", "h&m", "reserved", "massimo dutti",
            "є в наявност", "розпродаж", "акці",
            "до 50", "до 100", "до 200", "дешевш", "дорожч",
            // русские варианты
            "добавь в корзину", "добавь в кошик", "корзина", "найди", "ищу",
            "хочу купить", "есть ли", "покажи", "найдите"
    );
    ...
    private static final Set<String> RECOMMENDATION_KEYWORDS = Set.of(
            ...
            // русские варианты
            "посоветуй", "подбери", "что надеть",
            "что посоветуешь", "рекомендации", "хиты",
            "похожее",  "с чем носить"
    );
